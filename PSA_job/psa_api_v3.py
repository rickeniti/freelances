...
new_run = len(consulted_numbers) + 10
...
if os.path.exists(database_path):
    ...
    existing_df['Front image'] = '=' + existing_df['Front formula']
    existing_df['Back image'] = '=' + existing_df['Back formula']
...
while len(consulted_numbers) < new_run:
    ...
    try:
        ...
        try:
            ...
            back_aux = f'HYPERLINK("images/{filename_back}", "Image")'
            front_aux = f'HYPERLINK("images/{filename_front}", "Image")'
        ...
        card_info_list.append({
            ...
            'Front formula': front_aux,
            'Back formula': back_aux
        })
